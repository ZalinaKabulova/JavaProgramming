...
public class CarInsurance {
    ...
    public static void main(String[] args) {
        ...
        if(!(haveLicence.toUpperCase().equals("YES")))
        {
...
First things first, your program should ask customer to provide a name,
...
If zip code equals to 20910 or 20740, add $60 to the premium (an amount to
...
If car is for Commute - add $20 to the premium, and ask user how
many days per week user drives to work.
...
Display message: "Miles Driven To Work And/Or School". Increase premium
per $1 for every 1 mile.
...
Then, ask customer about driving experience. Make sure that experience
is greater than 0 and result of subtraction age from experience is greater
 or equals to 16. If no, display message: "Invalid data!" and stop the program.
  Reduce premium on $5 for every year of experience.

Then, ask customer about car accidents. Display message: "Have you had
any accidents in the last 5 years?".

If answer equals to "Yes" or "YES", ask customer about amount of accidents.
Display message: "How many?", in order to get information about amount of
 accidents. Add 20% to the premium price for every accident.
...
you need to insert customer's name. The display message: "Start Your Policy Today
For: $premium". Instead of premium, your program should print premium's variable value.

...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("Münich","Johnson&Johnson","SDET",120000,true,false,true,true);
        ...
        for (Offer offersWithBenefit : offersWithBenefits) {
            System.out.println("Offers with benefits - "+offersWithBenefit.companyName + " : "+offersWithBenefit.salary);
        }
        ...
        for (Offer sdetOffer : sdetOffers) {
            System.out.println("SDET and QA offers - "+sdetOffer.companyName+" : "+sdetOffer.salary);

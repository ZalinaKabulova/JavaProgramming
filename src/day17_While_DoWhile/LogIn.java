...
public class LogIn {
    public static void main(String[] args) {
        ...
        if (u.equals("Cydeo") && p.equals("Cydeo123")){
            ...
            System.out.println("Incorrect username ot password, please re-enter");
        ...
        Ask the user to enter their credentials.
                ...
                allow the user to have three attempts to enter correct
                credentials and if all three attempts are failed, then print
